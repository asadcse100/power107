...
class RouteServiceProvider extends ServiceProvider
{
  ...
  /**
   * Define the "Trading" routes for the application.
   *
   * These routes all receive session state, CSRF protection, etc.
   *
   * @return void
   */
  protected function mapTradingRoutes()
  {

    $test = Route::middleware('web')
       ->namespace($this->namespace)
       ->group(base_path('routes/trading.php'));
