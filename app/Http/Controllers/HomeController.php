...
use App\Http\Controllers\Controller\Trading\DashboardController;
...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        elseif(Auth::user()->user_type == 'trading'){
            $data = TradingProduct::getProductTrading();
            $liveTrade = TradingProduct::liveTrade();
            $page_name = 'trading';        
            return view('trading.frontend.dashboard', compact('data', 'liveTrade', 'page_name'));
        }
