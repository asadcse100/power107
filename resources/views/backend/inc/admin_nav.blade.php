    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-danger btn-sm d-flex align-items-center" target="_blank" href="{{Route('trading.index')}}">
                            <i class="las la-money fs-20"></i>
                            <span class="fw-500 ml-1 mr-0 d-none d-md-block">Trading</span>
                        </a>
                    </div>
                </div>
            </div>
            <!-- End Trading Dashboard button -->
        </div>
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
