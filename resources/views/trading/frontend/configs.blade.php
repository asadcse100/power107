...
@section('content')
  ...
  <div class="container-fluid">
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">{{__('Trading Registration Form')}}</li>
    </ul>
  </div>
...
<section class="no-padding-top">
    <div class="container-fluid">
          ...
          <div class="col-lg-10">
          <div class="block">
             <div class="title"><strong class="d-block">{{translate('Trading Information')}}</strong>
              <span class="d-block">Lorem ipsum dolor sit amet consectetur.</span>
            </div>
            <div class="block-body">
             <form action="{{ route('trading.configs.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-lg-8 form-horizontal" id="form">
							@foreach (json_decode(\App\ModelEcom\TradingConfig::where('type', 'verification_form')->first()->value) as $key => $element)
