                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('trading.apply') }}">{{__('Trading')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="" action="{{ route('trading.store_trading_user') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if (!Auth::check())
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                @php
                                    $verification_form = \App\Models\Trading\TradingConfig::where('type', 'verification_form')->first()->value;
                                @endphp
                                <div class="form-box-content p-3">
