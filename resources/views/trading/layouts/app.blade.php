...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('public/trading/img/favicon.ico')}}"/>
    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.gstatic.com">

    <!-- Styles -->
    @include('trading.inc.styles')  
</head>
@php
$has_scrollspy = "";
@endphp
