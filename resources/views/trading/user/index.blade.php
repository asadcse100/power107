@extends('trade.layouts.master',['activeSideNav' => active_side_nav()])
@section('title', $title)
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="my-4">
                    @component('trade.components.table',['class'=> 'lf-data-table'])
                        @slot('thead')
...
@section('style')
    @include('trade.layouts.includes.list-css')
@endsection

@section('script')
    @include('trade.layouts.includes.list-js')
@endsection
